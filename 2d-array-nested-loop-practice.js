...
function four() {
  var pentakill = [
    ["Deathfire Grasp", "Ohmwrecker", "Last Whisper"],
    ["Tear of the Goddess", "Mortal Reminder", "Rapidfire Cannon"]
  ];

  console.log(pentakill);

  pentakill[1][2] = "Dead Man's Plate";
  console.log(pentakill);
}
// four();
...
console.log(twoDCheck(fruits, "APPLE"));
console.log(twoDCheck(fruits, "AVOCADO"));